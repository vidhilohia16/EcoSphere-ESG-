        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <div className="dashboard-panel">
            ...
            <form onSubmit={handleCalculateAndLog} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              {activeFactor && (
                <div style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', padding: '10px', backgroundColor: 'rgba(24, 34, 58, 0.4)', borderRadius: '6px', border: '1px dashed var(--border-color)' }}>
          ...
          <div className="dashboard-panel">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '16px' }}>
              {products.map(prod => (
                <div key={prod.id} style={{ padding: '16px', backgroundColor: 'rgba(24,34,58,0.4)', border: '1px solid var(--border-color)', borderRadius: '8px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
